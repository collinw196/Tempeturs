...
import { OwnerHome, OwnerReserve, OwnerAppoint, OwnerPets, OwnerPetsAdd, OwnerSwitch, OwnerNot, OwnerPetEdit } from 'js/ownerPages';
		...
		return (
			<HashRouter>
				<div>
					...
					<Route exact path="/owner/pet/edit" component={OwnerPetEdit} />			
